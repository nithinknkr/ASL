...
<head>
    ...
    <link rel="stylesheet" href="Quiz-4.css">
</head>
<body>
    <div class="Quiz-box">
        <h1>Quiz-4</h1>
        <div class="Quiz-4-header">
    ...
    <div class="result-box" style="display:none;">
        ...
        <button class="result-button" id="next-quiz-button" onclick="window.location.href='Quiz-5.php'" style="display:none;">Next Quiz</button>
        
        
        <div id="confetti-container"></div>
    </div>
    
    <script src="Quiz-4.js"></script>
</body>
</html>
