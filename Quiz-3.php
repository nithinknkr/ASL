...
<head>
    ...
    <link rel="stylesheet" href="Quiz-3.css">
</head>
<body>
    <div class="Quiz-box">
        <h1>Quiz-3</h1>
        <div class="Quiz-3-header">
    ...
    <div class="result-box" style="display:none;">
        ...
        <button class="result-button" id="next-quiz-button" onclick="window.location.href='Quiz-4.php'" style="display:none;">Next Quiz</button>
        
        <!-- Confetti Container -->
        <div id="confetti-container"></div>
    </div>
    
    <script src="Quiz-3.js"></script>
</body>
</html>
